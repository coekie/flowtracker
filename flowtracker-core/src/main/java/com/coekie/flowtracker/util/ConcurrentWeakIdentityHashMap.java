...
// https://github.com/spring-projects/spring-loaded/blob/be39be1/springloaded/src/main/java/org/springsource/loaded/support/ConcurrentWeakIdentityHashMap.java
// side note: ehcache also has a ConcurrentWeakIdentityHashMap, but that has a bug where it doesn't
// use System identity hashcode ( https://github.com/ehcache/ehcache3/pull/1071 )
 ...
 * @param <V>
 */
@SuppressWarnings("all") // copy-pasted code
