  ...
  public void mergeTrackableValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue PointTracker\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation] []\n"
            + "GETSTATIC $THISTEST$.myByteArray : [B\n"
            + "ICONST_1\n"
            + "// begin ArrayLoadValue.insertTrackStatements\n"
            + "DUP2\n"
            ...
            + "L1\n"
            + "FRAME FULL [$THIS$ I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation] [I]\n"
            + "// begin InvocationReturnStore.insertTrackStatements\n"
            + "ALOAD 4\n"
            + "ACONST_NULL\n"
            + "ICONST_0\n"
  ...
  public void mergeCopyValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue PointTracker\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation I I] []\n"
            + "ILOAD 6\n"
            + "// TODO MergedValue.insertTrackStatements\n"
            + "L1\n"
            + "FRAME FULL [$THIS$ I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation I I] [I]\n"
            + "// begin InvocationReturnStore.insertTrackStatements\n"
            + "ALOAD 4\n"
            + "ACONST_NULL\n"
            + "ICONST_0\n"
