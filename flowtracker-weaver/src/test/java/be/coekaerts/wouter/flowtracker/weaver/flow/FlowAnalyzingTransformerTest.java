  ...
  public void mergeTrackableValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue array\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation] []\n"
            + "GETSTATIC $THISTEST$.myByteArray : [B\n"
            + "ICONST_1\n"
            + "// begin ArrayLoadValue.insertTrackStatements\n"
            + "ISTORE 3\n"
            ...
            + "// end ArrayLoadValue.insertTrackStatements\n"
            + "BALOAD\n"
            + "// TODO MergedValue.insertTrackStatements\n"
            + "L1\n"
            + "FRAME FULL [$THIS$ I [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation] [I]\n"
            + "// begin InvocationReturnStore.insertTrackStatements\n"
            + "ALOAD 8\n"
            + "ACONST_NULL\n"
            + "ICONST_0\n"
  ...
  public void mergeCopyValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue array\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation I I] []\n"
            + "ILOAD 10\n"
            + "// TODO MergedValue.insertTrackStatements\n"
            + "L1\n"
            + "FRAME FULL [$THIS$ I [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint [B I be/coekaerts/wouter/flowtracker/tracker/TrackerPoint be/coekaerts/wouter/flowtracker/tracker/Invocation I I] [I]\n"
            + "// begin InvocationReturnStore.insertTrackStatements\n"
            + "ALOAD 8\n"
            + "ACONST_NULL\n"
            + "ICONST_0\n"
