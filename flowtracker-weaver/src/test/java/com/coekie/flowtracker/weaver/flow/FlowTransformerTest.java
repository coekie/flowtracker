  ...
  public void invocationReturnValue() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal InvocationReturnValue invocation\n"
            ...
            + "LDC \"read ()I\"\n"
            + "INVOKESTATIC com/coekie/flowtracker/tracker/Invocation.createCalling (Ljava/lang/String;)Lcom/coekie/flowtracker/tracker/Invocation;\n"
            + "ASTORE 2\n"
  ...
  public void invocationArgStore() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue PointTracker\n"
            ...
            + "INVOKEVIRTUAL com/coekie/flowtracker/tracker/Invocation.calling ()Lcom/coekie/flowtracker/tracker/Invocation;\n"
            + "POP\n"
            + "// end InvocationOutgoingTransformation.ensureInstrumented\n"
            + "INVOKEVIRTUAL java/io/OutputStream.write (I)V\n"
            + "RETURN\n"
  ...
  public void mergeTrackableValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal MergedValue PointTracker\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Invocation] []\n"
            + "GETSTATIC $THISTEST$.myByteArray : [B\n"
            + "ICONST_1\n"
            + "// begin ArrayLoadValue.insertTrackStatements\n"
            + "DUP2\n"
            ...
            + "L1\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Invocation] [I]\n"
            + "// begin InvocationReturnStore.instrument\n"
            + "ALOAD 5\n"
            + "// MergedValue.loadSourcePoint\n"
            + "ALOAD 2\n"
  ...
  public void mergeCopyValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal MergedValue PointTracker\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Invocation I I] []\n"
            + "ILOAD 7\n"
            + "// MergedValue (TrackerPoint in 2)\n"
            + "// ArrayLoadValue.loadSourcePoint\n"
            + "ALOAD 3\n"
            ...
            + "// FYI MergedValue merges here (TrackerPoint in 2)\n"
            + "L1\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Invocation I I] [I]\n"
            + "// begin InvocationReturnStore.instrument\n"
            + "ALOAD 5\n"
            + "// MergedValue.loadSourcePoint\n"
            + "ALOAD 2\n"
