  ...
  public void testTracker() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue PointTracker\n"
            ...
            + "DUP2\n"
            + "INVOKESTATIC com/coekie/flowtracker/hook/ArrayLoadHook.getElementTracker (Ljava/lang/Object;I)Lcom/coekie/flowtracker/tracker/TrackerPoint;\n"
            + "ASTORE 3\n"
  ...
  public void testFrames() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue PointTracker\n"
            ...
            + "RETURN\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ [C [C I com/coekie/flowtracker/tracker/TrackerPoint I] []\n"
            + "ALOAD 1\n"
            + "ICONST_0\n"
            + "ILOAD 5\n"
            + "// begin ArrayStore.instrument: ArrayHook.set*(array, arrayIndex, value [already on stack], sourcePoint)\n"
            + "// ArrayLoadValue.loadSourcePoint\n"
            + "ALOAD 4\n"
            + "INVOKESTATIC com/coekie/flowtracker/hook/ArrayHook.setChar ([CICLcom/coekie/flowtracker/tracker/TrackerPoint;)V\n"
            + "// end ArrayStore.instrument\n"
            + "RETURN\n"
            + "MAXSTACK = 6\n"
            + "MAXLOCALS = 6\n");
  ...
  public void testFramesLoop() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue PointTracker\n"
            ...
            + "ASTORE 1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ com/coekie/flowtracker/tracker/TrackerPoint] []\n"
            + "GETSTATIC $THISTEST$.myBoolean : Z\n"
            + "IFEQ L1\n"
            + "GETSTATIC $THISTEST$.myCharArray : [C\n"
            + "ICONST_0\n"
  ...
  public void invocationReturnValue() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal InvocationReturnValue invocation\n"
            ...
            + "ALOAD 3\n"
            + "LDC \"read ()I\"\n"
            + "INVOKESTATIC com/coekie/flowtracker/tracker/Invocation.createCalling (Lcom/coekie/flowtracker/tracker/Context;Ljava/lang/String;)Lcom/coekie/flowtracker/tracker/Invocation;\n"
            + "ASTORE 2\n"
  ...
  public void mergeTrackableValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal MergedValue PointTracker\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Context com/coekie/flowtracker/tracker/Invocation] []\n"
            + "GETSTATIC $THISTEST$.myByteArray : [B\n"
            + "ICONST_1\n"
            + "// begin ArrayLoadValue.insertTrackStatements\n"
            + "DUP2\n"
            ...
            + "L1\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Context com/coekie/flowtracker/tracker/Invocation] [I]\n"
            + "// begin InvocationReturnStore.instrument\n"
            + "ALOAD 6\n"
            + "// MergedValue.loadSourcePoint\n"
            + "ALOAD 2\n"
  ...
  public void mergeCopyValues() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal MergedValue PointTracker\n"
            ...
            + "GOTO L1\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Context com/coekie/flowtracker/tracker/Invocation I I] []\n"
            + "ILOAD 8\n"
            + "// MergedValue (TrackerPoint in 2)\n"
            + "// ArrayLoadValue.loadSourcePoint\n"
            + "ALOAD 3\n"
            ...
            + "// FYI MergedValue merges here (TrackerPoint in 2)\n"
            + "L1\n"
            + "FRAME FULL [$THIS$ I com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/TrackerPoint com/coekie/flowtracker/tracker/Context com/coekie/flowtracker/tracker/Invocation I I] [I]\n"
            + "// begin InvocationReturnStore.instrument\n"
            + "ALOAD 6\n"
            + "// MergedValue.loadSourcePoint\n"
            + "ALOAD 2\n"
  ...
  public void simpleLoop() {
    testTransform(new Object() {
        ...
        "// Initialize newLocal ArrayLoadValue PointTracker\n"
            ...
            + "ISTORE 4\n"
            + "L0\n"
            + "FRAME FULL [$THIS$ com/coekie/flowtracker/tracker/TrackerPoint I I I] []\n"
            + "ILOAD 4\n"
            + "ICONST_2\n"
            + "IF_ICMPGE L1\n"
            + "GETSTATIC $THISTEST$.myByteArray : [B\n"
            ...
            + "GOTO L0\n"
            + "L1\n"
            + "FRAME FULL [$THIS$ com/coekie/flowtracker/tracker/TrackerPoint I I] []\n"
            + "RETURN\n"
            + "MAXSTACK = 6\n"
            + "MAXLOCALS = 5\n");
  }
